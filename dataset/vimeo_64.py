...
class Vimeo64Dataset(Dataset):
    ...
    def _apply_augmentation(self, frames, ref_frame_1, ref_frame_2, gt_frame):
        """
    ...
    def __getitem__(self, idx):
        ...
        if self.augment:
            frames, ref_frame_1, ref_frame_2, gt_frame = self._apply_augmentation(
                frames, ref_frame_1, ref_frame_2, gt_frame
            )
    ...
    def __getitem__(self, idx):
        ...
        if self.augment:
            frames, ref_frame_1, ref_frame_2, gt_frame = Vimeo64Dataset._apply_augmentation(
                None, frames, ref_frame_1, ref_frame_2, gt_frame
            )
