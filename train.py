...
def train_epoch(model: LIFT, dataloader, optimizer, scheduler, loss_fn: LIFTLoss, device, epoch, config, logger: TensorBoardLogger, global_step, scaler):
    """Train for one epoch."""
    model.train()
